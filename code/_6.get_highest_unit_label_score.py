...
annotation_file = open('_5 worker_annotations_per_fragment_no_spammers_no_writing_style_disagreement.csv', 'r')
...
label_cos_file = open('_6 average_unit_label_scores.csv', 'w')
label_for_task_file = open('_6 Task_2_input.csv', 'w')
...
for i in range(0, len(sorted_avg_annotation_frequencies)):
    ...
    label_for_task_file.write(i+'|'+str_info[0])
